      ...
      <nav className="bg-white shadow-md sticky top-0 z-10">
        <div className="container mx-auto px-4 py-4 flex justify-between items-center">
          ...
          <div className="hidden md:flex space-x-6">
            <Link to="/menu" className="text-gray-600 hover:text-indigo-600 font-medium">Menu</Link>
          ...
          <div className="flex space-x-3">
            <Link to="/login" className="text-indigo-600 border border-indigo-600 px-4 py-2 rounded-md hover:bg-indigo-50 font-medium">
              Log In
            </Link>
            <Link to="/signup" className="bg-indigo-600 text-white px-4 py-2 rounded-md hover:bg-indigo-700 font-medium">
              Sign Up
            </Link>
          </div>
        </div>
